...
public class MessageLogPanel : IUiElement
{
    ...
    public void PrintMessage(string message, int yPosition, Color color)
    {
        _contentConsole.Print(1, yPosition, message, color); // ✅ Ensures message uses the specified color
        _contentConsole.IsDirty = true; // ✅ Forces update
    }
}